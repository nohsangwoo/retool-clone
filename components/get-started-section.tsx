            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="border-gray-700 text-black dark:text-white hover:text-white dark:hover:text-black hover:bg-gray-800 dark:border-gray-400 dark:hover:bg-gray-200"
                >
                  BOOK A DEMO
                </Button>
              </div>
